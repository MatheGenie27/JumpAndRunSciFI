...
level1.level_end_x = 10000;
level1.level_begin_x = -2000;
//level1.floorObjects = [];
...
function createFloor() {
  ...
  let actual_x;
  actual_x = level1.level_begin_x;
  let count = 0;

  while (actual_x < level1.level_end_x) {
    level1.floorObjects.push(
      new BackgroundObject(
        "assets/img/backgrounds/bulkhead-walls/PNG/floor.png",
        actual_x,
        level1.ground_y,
        level1.backgroundSizingFactor,
        floor_width,
        floor_height
      )
    );
...
function createBackground() {
  ...
  while (actual_x < level1.level_end_x) {
    level1.backgroundObjects.push(
      new BackgroundObject(
        "assets/img/backgrounds/bulkhead-walls/PNG/bg-wall-with-supports.png",
        actual_x,
        level1.ground_y,
        level1.backgroundSizingFactor,
        bgws_width,
    ...
    level1.backgroundObjects.push(
      new BackgroundObject(
        "assets/img/backgrounds/bulkhead-walls/PNG/bg-wall.png",
        actual_x,
        level1.ground_y,
        level1.backgroundSizingFactor,
        bgw_width,
...
function createForeground() {
  ...
  while (actual_x < level1.level_end_x) {
    level1.foregroundObjects.push(
      new BackgroundObject(
        "assets/img/backgrounds/bulkhead-walls/PNG/foreground.png",
        actual_x,
        level1.ceiling_y,
        level1.backgroundSizingFactor,
        fg_width,
    ...
    actual_x =
      actual_x +
      2 * fg_width * Math.random() +
      0.5 * fg_width * level1.backgroundSizingFactor;
...
async function scriptCom() {
  console.log("ScriptCom: Ich wurde in level1.js aufgerufen");
  level1.enemies.push(new Shell(level1));
  level1.enemies.push(new Fly(level1));
  level1.enemies.push(new Punkgirl(level1));
}
